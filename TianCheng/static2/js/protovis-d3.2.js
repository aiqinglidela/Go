 ...
 * static3, ignoring the associated datum and returning a constant; or, it may be
 ...
 * {@link pv.Mark#add}.
 *
 * @class Represents an image, either a static3 resource or a dynamically-
...
/**
 * The width of the image in pixels. For static3 images, this property is
...
/**
 * The height of the image in pixels. For static3 images, this property is
 * computed implicitly from the loaded image resources. For dynamic images, this
 ...
 * specified and the <tt>url</tt> property is used to load a static3 image
 ...
 * convenient identification of the link's source, for example in a static3 JSON
 * representation.
 *
 * @type number
 ...
 * This attribute is not populated automatically, but may be used as a more
 * convenient identification of the link's target, for example in a static3 JSON
 * representation.
 *
 * @type number
